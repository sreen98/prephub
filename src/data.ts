...
export const menuStructure: MenuSection[] = [
  { name: 'Introduction', path: '/', file: './content/README.md' },
  {
    ...
    items: [
      ...
      { name: 'React Router', path: '/frontend/react-router', group: 'React & State', file: './content/front-end/react-router-guide.md', officialDocs: [{ label: 'React Router', url: 'https://reactrouter.com' }, { label: 'Upgrading to v7', url: 'https://reactrouter.com/upgrading/v6' }] },
